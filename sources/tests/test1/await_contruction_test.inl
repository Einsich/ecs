...
{
  DependanceFabric(): DefaultTypeFabric("EntityDependance", ecs::DefaultType, false, true){}
...
struct RandomFabric final : ecs::DefaultTypeFabric<RandomWaiter>
{
  RandomFabric(): DefaultTypeFabric("RandomFabric", ecs::DefaultType, false, true){}
