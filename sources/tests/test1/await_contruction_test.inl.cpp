...
{
  ecs::register_query(
  "sources/tests/test1/await_contruction_test.inl:106",
  "get_next_node",
  ...
  ecs::register_event(
  "sources/tests/test1/await_contruction_test.inl:58",
  "test_event",
  &test_event__cache__,
  {},
  {},
  ...
  ecs::register_event(
  "sources/tests/test1/await_contruction_test.inl:115",
  ...
  ecs::register_event(
  "sources/tests/test1/await_contruction_test.inl:127",
  "test_awaited_delete",
  ...
  ecs::register_event(
  "sources/tests/test1/await_contruction_test.inl:133",
