...
{
  ecs::register_query(
  "sources/tests/test7/dijkstra.inl:58",
  "iterate_nodes",
  ...
  ecs::register_query(
  "sources/tests/test7/dijkstra.inl:46",
  "get_node_edges",
  ...
  ecs::register_query(
  "sources/tests/test7/dijkstra.inl:66",
  "get_node_name",
  ...
  ecs::register_query(
  "sources/tests/test7/dijkstra.inl:85",
  "get_node_dist",
  ...
  ecs::register_query(
  "sources/tests/test7/dijkstra.inl:111",
  "get_node_edges_dist",
  ...
  ecs::register_query(
  "sources/tests/test7/dijkstra.inl:119",
  ...
  ecs::register_query(
  "sources/tests/test7/dijkstra.inl:141",
  "get_node_parent",
