...
namespace ecs
{
  ...
  template <typename T, bool trivial_ctor = false, bool trivial_dtor = false, bool trivial_move = false, bool trivial_copy = false>
  void type_registration(const char *type_name, const UserFunctions user_functions = UserFunctions{})
  {
    ...
    register_type(TypeIndex<T>::value, TypeAnnotation{type_name, ctor, copyCtor, moveCtor, dtor, user_functions});
  }
  template <typename T, bool trivial_ctor = false, bool trivial_dtor = false, bool trivial_move = false, bool trivial_copy = false>
  struct RegistrationHelper
  {
    ...
    {
      type_registration<T, trivial_ctor, trivial_dtor, trivial_move, trivial_copy>(name, user_functions);
    }
  };
...
#define ECS_TYPE_REGISTRATION(TYPE, NAME, TRIVIAL_CTOR, TRIVIAL_DTOR, TRIVIAL_MOVE, TRIVIAL_COPY, USER_FUNCTIONS) \
  static ecs::RegistrationHelper<TYPE, TRIVIAL_CTOR, TRIVIAL_DTOR, TRIVIAL_MOVE, TRIVIAL_COPY>                    \
